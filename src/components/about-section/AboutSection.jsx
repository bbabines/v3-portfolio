	...
	return (
		<div id="about" className={styles.container}>
			...
			<div className={styles.aboutContainer}>
				<p>
					Hello! My name is Brad and I enjoy building websites, applications,
				...
				<p>
					...
					introductory resources for this new chapter in my life. Afterwards, I
					further refined my coding skills from Bob Ziroll and Kevin Powell on
					Scrimba. I then decided to leave my formal education and career in
					healthcare behind. Fast-forward to today and I am working at a
					software company getting a foundation of technical knowledge under my
					belt while doing freelance web development on the side.
				</p>
				<p>
